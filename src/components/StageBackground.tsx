    ...
    <div className="fixed inset-0 -z-10 overflow-hidden bg-[#050505] no-print">
      <div className="absolute inset-0 opacity-50">
        <Image 
          ...
          priority
          data-ai-hint="concert lighting"
        />
      </div>
      
      {/* Degradado lateral profundo para legibilidad */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#050505] via-[#050505]/95 to-transparent w-full" />
      <div className="absolute inset-0 bg-black/20 backdrop-blur-[2px]" />

      {/* Efecto de luz dinámico sutil */}
      <svg className="absolute inset-0 w-full h-full opacity-10 pointer-events-none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M80% 0 L95% 100% L65% 100% Z" fill="url(#beam-gold)" className="animate-pulse" />
      </svg>
    </div>
  );
};

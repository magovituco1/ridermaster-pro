  ...
  return (
    <div className="relative min-h-screen bg-neutral-900 overflow-x-hidden">
      ...
      <main className="flex flex-col items-center py-12 print:p-0 print:py-0">
        {/* Contenedor que simula la hoja A4 Horizontal */}
        <div className="a4-landscape-page flex flex-col">
          ...
          <div className="mb-1 flex justify-between items-end">
            ...
            <p className="text-[8px] font-bold text-gray-300">DOC_ID: {rider.id?.substring(0,8).toUpperCase()}</p>
          </div>
                  ...
                  {(rider.songs || []).length > 0 ? (
                    ...
                    <tr>
                      <td colSpan={5} className="px-3 py-10 text-center text-gray-400 font-bold uppercase tracking-widest">
                        NO CUES REGISTERED FOR THIS RIDER
                      </td>
                    </tr>
                  )}
                </tbody>
